...
class Category extends Controller
{
    ...
    public function store()
    {
        ...
        if ($validation->run($data, 'category') == FALSE) {
            ...
            if ($simpan) {
                session()->setFlashdata('success', 'Create Category successfully');
    ...
    public function update()
    {
        ...
        if ($validation->run($data, 'category') == FALSE) {
            ...
            if ($ubah) {
                session()->setFlashdata('info', 'Update Category successfully');
                return redirect()->to(base_url('category'));
            }
        }
    }
    ...
    public function delete($id)
    {
        ...
        if ($hapus) {
            session()->setFlashdata('warning', 'Delete Category successfully');
            return redirect()->to(base_url('category'));
        }
    }
}
